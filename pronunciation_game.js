...
var sketchPronunciationGame = function(p) {
    ...
    const languageData = {
        ...
        'ja': {
            ...
            listeningText: '聞き取り中...',
            words: [
                ["燃料を取って。", "ドアをロックして。", "路面電車に走って！", "それはあなたのすぐ後ろにいます。", "雨に濡れないでください。", "あの電撃殺虫器が聞こえますか？"],
                ["夜になる前に窓を塞いでください。", "あれは私の声を完璧に真似ています。", "特定の予備部品を見つける必要があります。", "その声は扇風機のように歪んで聞こえます。", "路面電車には全員いますか？", "供給品の目録を再確認してください。"],
                ["その声はヘリウムのように不気味に甲高いです。", "このパラノイアの心理的影響は深刻です。", "あの生き物の解剖学的構造は理解できないほど恐ろしいです。", "破壊工作の兆候を細心の注意を払って探してください。", "路面電車のクロノメーターは即時同期が必要です。", "その喉から出るカタカタという音は指数関数的に大きくなっています。"]
            ]
        },
        'ko': {
            langCode: 'ko-KR',
